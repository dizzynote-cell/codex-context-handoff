...
The safety margin also draws on one long-running conversation of more than 200 turns, where the maintainer did not subjectively notice material drift until roughly the eighth or ninth context compaction. Beginning reminders at the fourth compaction is intended to leave about four to five compactions of handoff margin before that observed risk point, rather than waiting for drift to become visible. This remains a single practical observation, not a claim that every task drifts at the same point.
